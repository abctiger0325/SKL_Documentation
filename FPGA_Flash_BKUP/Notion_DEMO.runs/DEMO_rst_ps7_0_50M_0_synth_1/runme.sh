...
HD_PWD='/home/labish/Midget/SKL/FPGA_Flash_BKUP/Notion_DEMO.runs/DEMO_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_rst_ps7_0_50M_0.tcl
