...
HD_PWD='/home/labish/Midget/SKL/FPGA_Flash_BKUP/Notion_DEMO.runs/DEMO_LED_Connector_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_LED_Connector_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_LED_Connector_v1_0_0_0.tcl
